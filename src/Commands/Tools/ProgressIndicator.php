...
final class ProgressIndicator
{
	...
	public function __construct(OutputInterface $output)
	{
		...
		$this->progress = new ProgressBar($output->section());
	}
	 ...
	 * @return mixed
	 */
	public function execute(string $message, callable $callback)
	{
	 ...
	 * @throws Throwable
	 */
	private function render(Throwable $e, bool $throwExceptions = false): void
	{
